...
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
CFE_Status_t EXAMPLE_APP_TblValidationFunc(void *TblData)
{
    CFE_Status_t               ReturnCode = CFE_SUCCESS;
    EXAMPLE_APP_ExampleTable_t *TblDataPtr = (EXAMPLE_APP_ExampleTable_t *)TblData;

    /*
    ** Sample Example Table Validation
    */
    if (TblDataPtr->Int1 > EXAMPLE_APP_PLATFORM_TBL_ELEMENT_1_MAX)
    {
        /* First element is out of range, return an appropriate error code */
        ReturnCode = EXAMPLE_APP_PLATFORM_TABLE_OUT_OF_RANGE_ERR_CODE;
    }
...
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
void EXAMPLE_APP_GetCrc(const char *TableName)
{
    CFE_Status_t   status;
    uint32         Crc;
